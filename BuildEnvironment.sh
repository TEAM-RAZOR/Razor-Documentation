...
sleep 3
clear
echo Where do you want to initialize Razor source? Enter the desired directory name similar to this:
echo " /home/$USER/Razor or /media/$USER/yourdrive/Razor"
read Razorpath
clear
sleep 2
echo Creating and Initializing RR Source at $Razorpath in 5...
sleep 1
echo Creating and Initializing RR Source at $Razorpath in 4...
sleep 1
echo Creating and Initializing RR Source at $Razorpath in 3...
sleep 1
echo Creating and Initializing RR Source at $Razorpath in 2...
sleep 1
echo Creating and Initializing RR Source at $Razorpath in 1...
sleep 1
mkdir -p $Razorpath
cd $Razorpath
repo init -u git://github.com/TEAM-RAZOR/platform_manifest.git -b lp5.1
clear
echo Razor Source Code has been initialized!
sleep 4
clear
...
sleep 3
        ...
        repo sync -j $jobs
        clear
                echo Unpacking all Razor Resources in 5 seconds...
                sleep 1
                echo Unpacking all Razor Resources in 4 seconds...
                sleep 1
                echo Unpacking all Razor Resources in 3 seconds...
                sleep 1
                echo Unpacking all Razor Resources in 2 seconds...
                sleep 1
                echo Unpacking all Razor Resources in 1 seconds...
                sleep 1
        clear
        ...
        sleep 3
        clear
                echo Razor Source code has been Set-Up Succesfully in
                echo $Razorpath
sleep 3
